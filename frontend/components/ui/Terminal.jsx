export default function Terminal({ data, isLoading }) {
  return (
    <>
      <div className="w-full h-full flex flex-col bg-[#0d1117] border border-slate-800 rounded-lg overflow-hidden shadow-inner">
        ...
        <div className="p-4 overflow-auto flex-1 min-h-0 custom-scrollbar">
          {isLoading ? (
            <div className="flex items-center justify-center h-full text-slate-500 font-mono text-sm animate-pulse pt-10">
